...
public class TurretAlignCommandStatic extends CommandBase {
    private Drive drive;
    ...
    public TurretAlignCommandStatic(Drive drive, Turret turret, Drive.Alliance alliance, Vision vision,
    ...
    public TurretAlignCommandStatic(Follower follower, Turret turret, Drive.Alliance alliance, Vision vision) {
