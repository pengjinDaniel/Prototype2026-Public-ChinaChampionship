...
public class ShooterAlignCommandStatic extends CommandBase {
    private Drive drive;
    ...
    public ShooterAlignCommandStatic(Drive drive, Shooter shooter, Transit transit, Drive.Alliance alliance,
    ...
    public ShooterAlignCommandStatic(Follower follower, Shooter shooter, Transit transit, Drive.Alliance alliance) {
