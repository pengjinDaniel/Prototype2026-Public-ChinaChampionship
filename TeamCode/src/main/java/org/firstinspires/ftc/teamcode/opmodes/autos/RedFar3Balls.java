...
@Autonomous(name = "Red Far 3 Balls", group = "Auto")
public class RedFar3Balls extends CommandOpMode {
    ...
    public void initialize() {
        ...
        Path7 = follower.pathBuilder().addPath(
                        new BezierCurve(
                                new Pose(84.801, 11.079),
                                new Pose(86.412, 30.314),
                                new Pose(93.051, 36.455),
                                new Pose(122.670, 35.468)
                        )
                ).setLinearHeadingInterpolation(Math.toRadians(0), Math.toRadians(0))
