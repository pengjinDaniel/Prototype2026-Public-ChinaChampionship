...
public class DriveConstants {
    ...
    public static Pose2D blueGoalPose = new Pose2D(distanceUnit, 10.3, 135.3, angleUnit, 0);
    public static Pose2D redGoalPose = new Pose2D(distanceUnit, 131.2, 132, angleUnit, 0);
